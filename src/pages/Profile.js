...
const Profile = () => {
    ...
    useEffect(() => {
        const getCurrentUser = async () => {
            ...
            docSnap.forEach((doc) => {
                setCurrentProfileUser(doc.data());
            })
            ...
            <section className="flex justify-center">
                <div className="container max-w-5xl mt-7 relative pl-5 pr-5 flex flex-col">
                    <div className="flex mb-10">
                        ...
                        <div className="w-full">
                            <div className="flex items-center mb-8">
                                <p className="font-thin text-3xl mr-5 ">{currentProfileUser.displayName}</p>
                                <button className="rounded border px-2 py-1 text-sm font-semibold mr-5" type="button">Edit profile</button>
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="font-semibold mr-10"><span className="font-normal">followers: </span>0</p>
                                <p className="font-semibold"><span className="font-normal">following: </span>0</p>
                            </div>
                    ...
                    <div className="border-t w-full flex justify-center">
                        ...
                        <div
                            className={`mr-14 opacity-50 border-t active:opacity-25 ${location.pathname === '/' + currentProfileUser.displayName + '/saved' ? 'border-black opacity-100' : 'border-transparent'}`}
                            data-name="saved"
                        >
