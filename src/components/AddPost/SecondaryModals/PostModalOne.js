...
const PostModalOne = ({ activeModal, setActiveModal, setPage, setPost, post }) => {
    ...
    return (
        ...
        >
            <div className={`mx-5 lg:max-w-[700px] max-w-[400px] w-full h-[80vh] bg-white rounded-xl duration-300 ${activeModal ? 'opacity-1 scale-100' : 'opacity-0 scale-50'}`} onClick={(e) => e.stopPropagation()}>
